...
inline void sdeModel::sdeDr(double *dr, double *x, double *theta) {
  dr[0] = x[0]*(theta[0]+theta[3]*x[0]+theta[6]*x[1]+theta[9]*x[2]);
  dr[1] = x[1]*(theta[1]+theta[4]*x[0]+theta[7]*x[1]+theta[10]*x[2]);
  dr[2] = x[2]*(theta[2]+theta[5]*x[0]+theta[8]*x[1]+theta[11]*x[2]);
